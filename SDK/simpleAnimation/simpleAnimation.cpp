...
//------------------------------------------------------------------------------
//
//  simpleAnimation.cpp -- Renders a model with a time-varying warping transform.
//
//------------------------------------------------------------------------------
...
int main( int argc, char** argv ) 
{
  ...
  accel_desc.builder = "Lbvh"; // This builds faster than the default Trbvh, which has superfluous buffer copies at the moment.
